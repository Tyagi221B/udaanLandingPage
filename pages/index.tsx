...
const FloatingWhatsApp = () => {
  return (
    <a
      href="https://wa.me/917526006701?text=Hello%2C%20I%20am%20interested%20in%20your%20services"
      target="_blank"
  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.udaanSection}>
        <div className={styles.udaanContainer}>
          ...
          >
            ...
            <form onSubmit={handleUdaanSubmit} className={styles.udaanForm}>
              <div className={styles.formRow}>
                <input
                  ...
                  name="firstname"
                  value={udaanForm.firstname}
                  onChange={handleUdaanChange}
                />
                <input
                  required
                  type="text"
          ...
          >
            ...
            <h3>Join UDAAN & Get Ahead in Your IAS</h3>
            <p>
              After 12<sup>th</sup> Class! Prep – Limited Seats, Enroll Now!
              <br />
              <br />
      ...
      <section className={styles.whyDhyeya}>
        ...
        <a
          href="https://wa.me/917526006701?text=Sir%2FMa%27am%2C%20I%20want%20personalized%20guidance"
          target="_blank"
          rel="noopener noreferrer"
        >
          <motion.button
